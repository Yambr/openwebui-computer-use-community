...
**You must use ES Modules with full path (import) syntax:**

```javascript
// Use ES module imports with FULL PATH - package name imports don't work
import pptxgen from 'pptxgenjs';
import { html2pptx } from '/home/assistant/.npm-global/lib/node_modules/@ant/html2pptx/dist/html2pptx.mjs';
...
- You MUST use the full path to `html2pptx.mjs` (not package name)
- Other packages like `pptxgenjs` and `react` work with package names because they're installed locally in `/home/assistant/node_modules/`
