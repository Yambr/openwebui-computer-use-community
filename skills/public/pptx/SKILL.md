...
If you have brand guidelines, you can customize presentations with:
...
:root {
  ...
  --color-primary-dark: #0055CC;   /* Darker variant */
  --color-surface: #FFFFFF;        /* Background color */
  --color-surface-foreground: #000000;  /* Text on surface */
  --color-muted: #F5F5F5;          /* Muted backgrounds */
  --color-muted-foreground: #666666;    /* Muted text */
...
Place brand assets in `assets/your-brand/`:

| Category | Files | Usage |
|----------|-------|-------|
| **Logos** | `logos/logo-color.png` | Standard backgrounds |
| | `logos/logo-white.png` | Dark backgrounds |
| **Icons** | `icons/icon.png` | Decorative elements |
